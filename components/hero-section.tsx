    ...
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col items-start justify-center px-6 lg:px-8">
        <div className="max-w-2xl">
          <p
            className="mt-14 sm:mt-0 animate-fade-up text-sm font-medium uppercase tracking-[0.3em] text-primary"
        ...
        >
          <div className="flex flex-wrap items-center mb-4 sm:mb-0 justify-center gap-8 rounded-2xl border border-border/50 bg-card/80 px-8 py-6 backdrop-blur-sm md:justify-between">
            {[
              { value: "5+", label: "Let zkušeností" },
              { value: "10 00+", label: "Spokojených klientů" },
              { value: "10+", label: "Procedur" },
